...
name="SMKTQA" #The bot will consider this person as its owner or creator
bot_name="TQChat" #This will be the name of your bot, eg: "Hello I am Astro Bot"
model_name="gemini-2.5-flash" #Switch to "gemini-1.0-pro" or any free model, if "gemini-1.5-flash" becomes paid in future.
